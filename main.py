...
Musk's political activities, views, and statements have made Musk a polarizing figure. Musk has been criticized for COVID-19 misinformation, promoting conspiracy theories, and affirming antisemitic, racist, and transphobic comments. His acquisition of Twitter was controversial due to a subsequent increase in hate speech and the spread of misinformation on the service, following his pledge to decrease censorship. His role in the second Trump administration attracted public backlash, particularly in response to DOGE. The emails Musk sent to Jeffrey Epstein are included in the Epstein files, which were published in 2025 and 2026 and became a topic of worldwide debate.
    
    
    """
#At first information is the string of information

    summary_template="""
    Summarize the following information {information} about a person i want you to create:
    1) A short summary
    2)two interesting facts about them
    """
#Now summary_template was the template of prompt give to llm
#So this is written like a prompt and {information} is the input variable
#We should use this and not fstring as this is more efficeint

#In summary_prompt_template we are creating a prompt template object and specifying the template and input variables
